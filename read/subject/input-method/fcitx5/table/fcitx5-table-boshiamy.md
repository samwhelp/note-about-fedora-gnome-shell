...
| 微調腳本 | 中文輸入法 |
| -------- | ---------- |
| [fcitx5-table-boshiamy 安裝設定腳本](https://github.com/samwhelp/fedora-gnome-shell-adjustment/tree/main/prototype/main/im-config/fcitx5/fcitx5-table-boshiamy) | 嘸蝦米輸入法 |
